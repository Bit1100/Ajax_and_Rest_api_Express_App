...
const updateUser = async () => {
    try {
        const updateValues = prompt("Please Enter UserID to be updated and active field value as true/false in the format of  id,value");
        ...
        const response = await fetch(`/api/users/${id}/${active}`, { method: "PATCH" });   //AJAX via fetch() API
...
function populateUsers(users) {
    apiDataContainer.innerHTML = users.map((user) => {
